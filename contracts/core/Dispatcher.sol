...
contract Dispatcher is OwnableUpgradeable, UUPSUpgradeable, IDispatcher {
    ...
    LightClient lightClient; // Can't be set to immutable since it needs to be called in the initializer; not the
    ...
    function timeout(IbcPacketReceiver receiver, IbcPacket calldata packet, Ics23Proof calldata proof) external {
        ...
        lightClient.verifyNonMembership(proof, Ibc.packetCommitmentProofKey(packet));
