...
func (_OptimisticLightClient *OptimisticLightClientCaller) GetLightClientType(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _OptimisticLightClient.contract.Call(opts, &out, "getLightClientType")
...
//
// Solidity: function getLightClientType() pure returns(uint8)
func (_OptimisticLightClient *OptimisticLightClientSession) GetLightClientType() (uint8, error) {
	return _OptimisticLightClient.Contract.GetLightClientType(&_OptimisticLightClient.CallOpts)
}

// GetLightClientType is a free data retrieval call binding the contract method 0x36028d2a.
//
// Solidity: function getLightClientType() pure returns(uint8)
func (_OptimisticLightClient *OptimisticLightClientCallerSession) GetLightClientType() (uint8, error) {
	return _OptimisticLightClient.Contract.GetLightClientType(&_OptimisticLightClient.CallOpts)
}
