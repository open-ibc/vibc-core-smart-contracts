...
// UpdateClientWithOptimisticConsensusState is a paid mutator transaction binding the contract method 0x583ba847.
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes l1header, bytes proof, uint256 height, uint256 appHash, string connection) returns(uint256 fraudProofEndTime, bool ended)
func (_IDispatcher *IDispatcherTransactor) UpdateClientWithOptimisticConsensusState(opts *bind.TransactOpts, l1header []byte, proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
...
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes l1header, bytes proof, uint256 height, uint256 appHash, string connection) returns(uint256 fraudProofEndTime, bool ended)
func (_IDispatcher *IDispatcherSession) UpdateClientWithOptimisticConsensusState(l1header []byte, proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
...
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes l1header, bytes proof, uint256 height, uint256 appHash, string connection) returns(uint256 fraudProofEndTime, bool ended)
func (_IDispatcher *IDispatcherTransactorSession) UpdateClientWithOptimisticConsensusState(l1header []byte, proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _IDispatcher.Contract.UpdateClientWithOptimisticConsensusState(&_IDispatcher.TransactOpts, l1header, proof, height, appHash, connection)
}
