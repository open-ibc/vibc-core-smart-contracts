...
//
// Solidity: function getOptimisticConsensusState(uint256 height, string connection) view returns(uint256 appHash)
func (_IDispatcher *IDispatcherCaller) GetOptimisticConsensusState(opts *bind.CallOpts, height *big.Int, connection string) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getOptimisticConsensusState(uint256 height, string connection) view returns(uint256 appHash)
func (_IDispatcher *IDispatcherSession) GetOptimisticConsensusState(height *big.Int, connection string) (*big.Int, error) {
...
//
// Solidity: function getOptimisticConsensusState(uint256 height, string connection) view returns(uint256 appHash)
func (_IDispatcher *IDispatcherCallerSession) GetOptimisticConsensusState(height *big.Int, connection string) (*big.Int, error) {
	return _IDispatcher.Contract.GetOptimisticConsensusState(&_IDispatcher.CallOpts, height, connection)
}
...
// UpdateClientWithOptimisticConsensusState is a paid mutator transaction binding the contract method 0xcc3c51cb.
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes proof, uint256 height, uint256 appHash, string connection) returns()
func (_IDispatcher *IDispatcherTransactor) UpdateClientWithOptimisticConsensusState(opts *bind.TransactOpts, proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _IDispatcher.contract.Transact(opts, "updateClientWithOptimisticConsensusState", proof, height, appHash, connection)
}

// UpdateClientWithOptimisticConsensusState is a paid mutator transaction binding the contract method 0xcc3c51cb.
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes proof, uint256 height, uint256 appHash, string connection) returns()
func (_IDispatcher *IDispatcherSession) UpdateClientWithOptimisticConsensusState(proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _IDispatcher.Contract.UpdateClientWithOptimisticConsensusState(&_IDispatcher.TransactOpts, proof, height, appHash, connection)
}

// UpdateClientWithOptimisticConsensusState is a paid mutator transaction binding the contract method 0xcc3c51cb.
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes proof, uint256 height, uint256 appHash, string connection) returns()
func (_IDispatcher *IDispatcherTransactorSession) UpdateClientWithOptimisticConsensusState(proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _IDispatcher.Contract.UpdateClientWithOptimisticConsensusState(&_IDispatcher.TransactOpts, proof, height, appHash, connection)
}
