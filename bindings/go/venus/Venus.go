...
var VenusMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"constructor\",\"inputs\":[{\"name\":\"_prover\",\"type\":\"address\",\"internalType\":\"contractICrossL2Prover\"}],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"checkEventProof\",\"inputs\":[{\"name\":\"receiptIndex\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"receiptRLPEncodedBytes\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"logIndex\",\"type\":\"uint256\",\"internalType\":\"uint256\"},{\"name\":\"logBytes\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"proof\",\"type\":\"bytes\",\"internalType\":\"bytes\"}],\"outputs\":[],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"checkReceiptProof\",\"inputs\":[{\"name\":\"receiptIndex\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"receiptRLPEncodedBytes\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"proof\",\"type\":\"bytes\",\"internalType\":\"bytes\"}],\"outputs\":[],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"prover\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"contractICrossL2Prover\"}],\"stateMutability\":\"view\"},{\"type\":\"event\",\"name\":\"SuccessfulEvent\",\"inputs\":[{\"name\":\"eventIndex\",\"type\":\"uint256\",\"indexed\":false,\"internalType\":\"uint256\"},{\"name\":\"eventBytes\",\"type\":\"bytes\",\"indexed\":false,\"internalType\":\"bytes\"}],\"anonymous\":false},{\"type\":\"event\",\"name\":\"SuccessfulReceipt\",\"inputs\":[{\"name\":\"receiptIndex\",\"type\":\"bytes\",\"indexed\":false,\"internalType\":\"bytes\"},{\"name\":\"receiptRLP\",\"type\":\"bytes\",\"indexed\":false,\"internalType\":\"bytes\"}],\"anonymous\":false},{\"type\":\"error\",\"name\":\"invalidEventProof\",\"inputs\":[]},{\"type\":\"error\",\"name\":\"invalidReceiptProof\",\"inputs\":[]}]",
}
...
// CheckEventProof is a paid mutator transaction binding the contract method 0xe948973c.
//
// Solidity: function checkEventProof(bytes receiptIndex, bytes receiptRLPEncodedBytes, uint256 logIndex, bytes logBytes, bytes proof) returns()
func (_Venus *VenusTransactor) CheckEventProof(opts *bind.TransactOpts, receiptIndex []byte, receiptRLPEncodedBytes []byte, logIndex *big.Int, logBytes []byte, proof []byte) (*types.Transaction, error) {
	return _Venus.contract.Transact(opts, "checkEventProof", receiptIndex, receiptRLPEncodedBytes, logIndex, logBytes, proof)
}

// CheckEventProof is a paid mutator transaction binding the contract method 0xe948973c.
//
// Solidity: function checkEventProof(bytes receiptIndex, bytes receiptRLPEncodedBytes, uint256 logIndex, bytes logBytes, bytes proof) returns()
func (_Venus *VenusSession) CheckEventProof(receiptIndex []byte, receiptRLPEncodedBytes []byte, logIndex *big.Int, logBytes []byte, proof []byte) (*types.Transaction, error) {
	return _Venus.Contract.CheckEventProof(&_Venus.TransactOpts, receiptIndex, receiptRLPEncodedBytes, logIndex, logBytes, proof)
}

// CheckEventProof is a paid mutator transaction binding the contract method 0xe948973c.
//
// Solidity: function checkEventProof(bytes receiptIndex, bytes receiptRLPEncodedBytes, uint256 logIndex, bytes logBytes, bytes proof) returns()
func (_Venus *VenusTransactorSession) CheckEventProof(receiptIndex []byte, receiptRLPEncodedBytes []byte, logIndex *big.Int, logBytes []byte, proof []byte) (*types.Transaction, error) {
	return _Venus.Contract.CheckEventProof(&_Venus.TransactOpts, receiptIndex, receiptRLPEncodedBytes, logIndex, logBytes, proof)
}

// CheckReceiptProof is a paid mutator transaction binding the contract method 0x04d9bdce.
//
// Solidity: function checkReceiptProof(bytes receiptIndex, bytes receiptRLPEncodedBytes, bytes proof) returns()
func (_Venus *VenusTransactor) CheckReceiptProof(opts *bind.TransactOpts, receiptIndex []byte, receiptRLPEncodedBytes []byte, proof []byte) (*types.Transaction, error) {
	return _Venus.contract.Transact(opts, "checkReceiptProof", receiptIndex, receiptRLPEncodedBytes, proof)
}

// CheckReceiptProof is a paid mutator transaction binding the contract method 0x04d9bdce.
//
// Solidity: function checkReceiptProof(bytes receiptIndex, bytes receiptRLPEncodedBytes, bytes proof) returns()
func (_Venus *VenusSession) CheckReceiptProof(receiptIndex []byte, receiptRLPEncodedBytes []byte, proof []byte) (*types.Transaction, error) {
	return _Venus.Contract.CheckReceiptProof(&_Venus.TransactOpts, receiptIndex, receiptRLPEncodedBytes, proof)
}

// CheckReceiptProof is a paid mutator transaction binding the contract method 0x04d9bdce.
//
// Solidity: function checkReceiptProof(bytes receiptIndex, bytes receiptRLPEncodedBytes, bytes proof) returns()
func (_Venus *VenusTransactorSession) CheckReceiptProof(receiptIndex []byte, receiptRLPEncodedBytes []byte, proof []byte) (*types.Transaction, error) {
	return _Venus.Contract.CheckReceiptProof(&_Venus.TransactOpts, receiptIndex, receiptRLPEncodedBytes, proof)
}
...
// FilterSuccessfulEvent is a free log retrieval operation binding the contract event 0xf0b2800d2a52f3328cbfb7d73bf392375f8b39e3d96b5ea67db544393ea06ed9.
//
// Solidity: event SuccessfulEvent(uint256 eventIndex, bytes eventBytes)
...
// WatchSuccessfulEvent is a free log subscription operation binding the contract event 0xf0b2800d2a52f3328cbfb7d73bf392375f8b39e3d96b5ea67db544393ea06ed9.
//
// Solidity: event SuccessfulEvent(uint256 eventIndex, bytes eventBytes)
...
// ParseSuccessfulEvent is a log parse operation binding the contract event 0xf0b2800d2a52f3328cbfb7d73bf392375f8b39e3d96b5ea67db544393ea06ed9.
//
// Solidity: event SuccessfulEvent(uint256 eventIndex, bytes eventBytes)
