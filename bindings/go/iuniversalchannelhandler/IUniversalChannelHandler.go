...
func (_IUniversalChannelHandler *IUniversalChannelHandlerTransactor) OnChanOpenInit(opts *bind.TransactOpts, order uint8, connectionHops []string, counterpartyPortIdentifier string, version string) (*types.Transaction, error) {
	return _IUniversalChannelHandler.contract.Transact(opts, "onChanOpenInit", order, connectionHops, counterpartyPortIdentifier, version)
}

// OnChanOpenInit is a paid mutator transaction binding the contract method 0x7a9ccc4b.
//
// Solidity: function onChanOpenInit(uint8 order, string[] connectionHops, string counterpartyPortIdentifier, string version) returns(string selectedVersion)
func (_IUniversalChannelHandler *IUniversalChannelHandlerSession) OnChanOpenInit(order uint8, connectionHops []string, counterpartyPortIdentifier string, version string) (*types.Transaction, error) {
	return _IUniversalChannelHandler.Contract.OnChanOpenInit(&_IUniversalChannelHandler.TransactOpts, order, connectionHops, counterpartyPortIdentifier, version)
}

// OnChanOpenInit is a paid mutator transaction binding the contract method 0x7a9ccc4b.
//
// Solidity: function onChanOpenInit(uint8 order, string[] connectionHops, string counterpartyPortIdentifier, string version) returns(string selectedVersion)
func (_IUniversalChannelHandler *IUniversalChannelHandlerTransactorSession) OnChanOpenInit(order uint8, connectionHops []string, counterpartyPortIdentifier string, version string) (*types.Transaction, error) {
	return _IUniversalChannelHandler.Contract.OnChanOpenInit(&_IUniversalChannelHandler.TransactOpts, order, connectionHops, counterpartyPortIdentifier, version)
}
