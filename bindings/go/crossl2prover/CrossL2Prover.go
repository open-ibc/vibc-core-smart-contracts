...
//
// Solidity: function clientType() view returns(bytes32)
func (_CrossL2Prover *CrossL2ProverCaller) ClientType(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function clientType() view returns(bytes32)
func (_CrossL2Prover *CrossL2ProverSession) ClientType() ([32]byte, error) {
...
//
// Solidity: function clientType() view returns(bytes32)
func (_CrossL2Prover *CrossL2ProverCallerSession) ClientType() ([32]byte, error) {
	return _CrossL2Prover.Contract.ClientType(&_CrossL2Prover.CallOpts)
}
