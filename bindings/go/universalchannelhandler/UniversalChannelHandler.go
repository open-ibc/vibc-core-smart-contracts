...
func (_UniversalChannelHandler *UniversalChannelHandlerTransactor) TriggerChannelInit(opts *bind.TransactOpts, version string, ordering uint8, feeEnabled bool, connectionHops []string, counterpartyPortIdentifier string) (*types.Transaction, error) {
	return _UniversalChannelHandler.contract.Transact(opts, "triggerChannelInit", version, ordering, feeEnabled, connectionHops, counterpartyPortIdentifier)
}

// TriggerChannelInit is a paid mutator transaction binding the contract method 0x7a805598.
//
// Solidity: function triggerChannelInit(string version, uint8 ordering, bool feeEnabled, string[] connectionHops, string counterpartyPortIdentifier) returns()
func (_UniversalChannelHandler *UniversalChannelHandlerSession) TriggerChannelInit(version string, ordering uint8, feeEnabled bool, connectionHops []string, counterpartyPortIdentifier string) (*types.Transaction, error) {
	return _UniversalChannelHandler.Contract.TriggerChannelInit(&_UniversalChannelHandler.TransactOpts, version, ordering, feeEnabled, connectionHops, counterpartyPortIdentifier)
}

// TriggerChannelInit is a paid mutator transaction binding the contract method 0x7a805598.
//
// Solidity: function triggerChannelInit(string version, uint8 ordering, bool feeEnabled, string[] connectionHops, string counterpartyPortIdentifier) returns()
func (_UniversalChannelHandler *UniversalChannelHandlerTransactorSession) TriggerChannelInit(version string, ordering uint8, feeEnabled bool, connectionHops []string, counterpartyPortIdentifier string) (*types.Transaction, error) {
	return _UniversalChannelHandler.Contract.TriggerChannelInit(&_UniversalChannelHandler.TransactOpts, version, ordering, feeEnabled, connectionHops, counterpartyPortIdentifier)
}
