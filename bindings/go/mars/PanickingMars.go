...
func (_PanickingMars *PanickingMarsCaller) OnChanOpenInit(opts *bind.CallOpts, arg0 uint8, arg1 []string, arg2 string, version string) (string, error) {
	var out []interface{}
	err := _PanickingMars.contract.Call(opts, &out, "onChanOpenInit", arg0, arg1, arg2, version)
...
//
// Solidity: function onChanOpenInit(uint8 , string[] , string , string version) view returns(string selectedVersion)
func (_PanickingMars *PanickingMarsSession) OnChanOpenInit(arg0 uint8, arg1 []string, arg2 string, version string) (string, error) {
	return _PanickingMars.Contract.OnChanOpenInit(&_PanickingMars.CallOpts, arg0, arg1, arg2, version)
}

// OnChanOpenInit is a free data retrieval call binding the contract method 0x7a9ccc4b.
//
// Solidity: function onChanOpenInit(uint8 , string[] , string , string version) view returns(string selectedVersion)
func (_PanickingMars *PanickingMarsCallerSession) OnChanOpenInit(arg0 uint8, arg1 []string, arg2 string, version string) (string, error) {
	return _PanickingMars.Contract.OnChanOpenInit(&_PanickingMars.CallOpts, arg0, arg1, arg2, version)
}
