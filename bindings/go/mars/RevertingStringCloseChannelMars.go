...
// OnChanCloseInit is a free data retrieval call binding the contract method 0x1eb7dd5e.
//
// Solidity: function onChanCloseInit(bytes32 , string , bytes32 ) view returns()
func (_RevertingStringCloseChannelMars *RevertingStringCloseChannelMarsCaller) OnChanCloseInit(opts *bind.CallOpts, arg0 [32]byte, arg1 string, arg2 [32]byte) error {
	var out []interface{}
	err := _RevertingStringCloseChannelMars.contract.Call(opts, &out, "onChanCloseInit", arg0, arg1, arg2)
...
//
// Solidity: function onChanCloseInit(bytes32 , string , bytes32 ) view returns()
func (_RevertingStringCloseChannelMars *RevertingStringCloseChannelMarsSession) OnChanCloseInit(arg0 [32]byte, arg1 string, arg2 [32]byte) error {
	return _RevertingStringCloseChannelMars.Contract.OnChanCloseInit(&_RevertingStringCloseChannelMars.CallOpts, arg0, arg1, arg2)
}

// OnChanCloseInit is a free data retrieval call binding the contract method 0x1eb7dd5e.
//
// Solidity: function onChanCloseInit(bytes32 , string , bytes32 ) view returns()
func (_RevertingStringCloseChannelMars *RevertingStringCloseChannelMarsCallerSession) OnChanCloseInit(arg0 [32]byte, arg1 string, arg2 [32]byte) error {
	return _RevertingStringCloseChannelMars.Contract.OnChanCloseInit(&_RevertingStringCloseChannelMars.CallOpts, arg0, arg1, arg2)
}
...
func (_RevertingStringCloseChannelMars *RevertingStringCloseChannelMarsCaller) OnChanOpenInit(opts *bind.CallOpts, arg0 uint8, arg1 []string, arg2 string, version string) (string, error) {
	var out []interface{}
	err := _RevertingStringCloseChannelMars.contract.Call(opts, &out, "onChanOpenInit", arg0, arg1, arg2, version)
...
//
// Solidity: function onChanOpenInit(uint8 , string[] , string , string version) view returns(string selectedVersion)
func (_RevertingStringCloseChannelMars *RevertingStringCloseChannelMarsSession) OnChanOpenInit(arg0 uint8, arg1 []string, arg2 string, version string) (string, error) {
	return _RevertingStringCloseChannelMars.Contract.OnChanOpenInit(&_RevertingStringCloseChannelMars.CallOpts, arg0, arg1, arg2, version)
}

// OnChanOpenInit is a free data retrieval call binding the contract method 0x7a9ccc4b.
//
// Solidity: function onChanOpenInit(uint8 , string[] , string , string version) view returns(string selectedVersion)
func (_RevertingStringCloseChannelMars *RevertingStringCloseChannelMarsCallerSession) OnChanOpenInit(arg0 uint8, arg1 []string, arg2 string, version string) (string, error) {
	return _RevertingStringCloseChannelMars.Contract.OnChanOpenInit(&_RevertingStringCloseChannelMars.CallOpts, arg0, arg1, arg2, version)
}
