...
func (_Dispatcher *DispatcherCaller) GetOptimisticConsensusState(opts *bind.CallOpts, height *big.Int, connection string) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getOptimisticConsensusState(uint256 height, string connection) view returns(uint256 appHash)
func (_Dispatcher *DispatcherSession) GetOptimisticConsensusState(height *big.Int, connection string) (*big.Int, error) {
...
//
// Solidity: function getOptimisticConsensusState(uint256 height, string connection) view returns(uint256 appHash)
func (_Dispatcher *DispatcherCallerSession) GetOptimisticConsensusState(height *big.Int, connection string) (*big.Int, error) {
	return _Dispatcher.Contract.GetOptimisticConsensusState(&_Dispatcher.CallOpts, height, connection)
}
...
func (_Dispatcher *DispatcherTransactor) UpdateClientWithOptimisticConsensusState(opts *bind.TransactOpts, proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _Dispatcher.contract.Transact(opts, "updateClientWithOptimisticConsensusState", proof, height, appHash, connection)
}

// UpdateClientWithOptimisticConsensusState is a paid mutator transaction binding the contract method 0xcc3c51cb.
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes proof, uint256 height, uint256 appHash, string connection) returns()
func (_Dispatcher *DispatcherSession) UpdateClientWithOptimisticConsensusState(proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _Dispatcher.Contract.UpdateClientWithOptimisticConsensusState(&_Dispatcher.TransactOpts, proof, height, appHash, connection)
}

// UpdateClientWithOptimisticConsensusState is a paid mutator transaction binding the contract method 0xcc3c51cb.
//
// Solidity: function updateClientWithOptimisticConsensusState(bytes proof, uint256 height, uint256 appHash, string connection) returns()
func (_Dispatcher *DispatcherTransactorSession) UpdateClientWithOptimisticConsensusState(proof []byte, height *big.Int, appHash *big.Int, connection string) (*types.Transaction, error) {
	return _Dispatcher.Contract.UpdateClientWithOptimisticConsensusState(&_Dispatcher.TransactOpts, proof, height, appHash, connection)
}
