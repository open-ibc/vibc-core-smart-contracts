...
//
// Solidity: function initialize(string initPortPrefix) returns()
func (_Dispatcher *DispatcherTransactor) Initialize(opts *bind.TransactOpts, initPortPrefix string) (*types.Transaction, error) {
	return _Dispatcher.contract.Transact(opts, "initialize", initPortPrefix)
}

// Initialize is a paid mutator transaction binding the contract method 0xf62d1888.
//
// Solidity: function initialize(string initPortPrefix) returns()
func (_Dispatcher *DispatcherSession) Initialize(initPortPrefix string) (*types.Transaction, error) {
	return _Dispatcher.Contract.Initialize(&_Dispatcher.TransactOpts, initPortPrefix)
}

// Initialize is a paid mutator transaction binding the contract method 0xf62d1888.
//
// Solidity: function initialize(string initPortPrefix) returns()
func (_Dispatcher *DispatcherTransactorSession) Initialize(initPortPrefix string) (*types.Transaction, error) {
	return _Dispatcher.Contract.Initialize(&_Dispatcher.TransactOpts, initPortPrefix)
}
...
//
// Solidity: function sendPacket(bytes32 channelId, bytes packet, uint64 timeoutTimestamp) returns()
