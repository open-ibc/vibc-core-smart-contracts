...
export interface RevertingStringCloseChannelMarsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ackPackets"
      | "connectedChannels"
...
export interface RevertingStringCloseChannelMars extends BaseContract {
  connect(runner?: ContractRunner | null): RevertingStringCloseChannelMars;
  waitForDeployment(): Promise<this>;

  interface: RevertingStringCloseChannelMarsInterface;
