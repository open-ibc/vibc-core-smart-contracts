...
export interface RevertingStringMarsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ackPackets"
      | "connectedChannels"
...
export interface RevertingStringMars extends BaseContract {
  connect(runner?: ContractRunner | null): RevertingStringMars;
  waitForDeployment(): Promise<this>;

  interface: RevertingStringMarsInterface;
  ...
  onAcknowledgementPacket: TypedContractMethod<
    [arg0: IbcPacketStruct, arg1: AckPacketStruct],
    [void],
    "view"
  >;
  ...
  onChanOpenAck: TypedContractMethod<
    [arg0: BytesLike, arg1: BytesLike, arg2: string],
    [void],
    "view"
  >;
  ...
  onChanOpenInit: TypedContractMethod<
    [arg0: BigNumberish, arg1: string[], arg2: string, arg3: string],
    [string],
    "view"
  >;
