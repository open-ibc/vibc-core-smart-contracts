...
export interface RevertingEmptyMarsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ackPackets"
      | "connectedChannels"
...
export interface RevertingEmptyMars extends BaseContract {
  connect(runner?: ContractRunner | null): RevertingEmptyMars;
  waitForDeployment(): Promise<this>;

  interface: RevertingEmptyMarsInterface;
