...
export interface OpProofVerifierInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface OpProofVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): OpProofVerifier;
  waitForDeployment(): Promise<this>;

  interface: OpProofVerifierInterface;
