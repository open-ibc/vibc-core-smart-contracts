...
export interface IMembershipVerifierInterface extends Interface {
  getFunction(nameOrSignature: "verifyMembership"): FunctionFragment;
...
export interface IMembershipVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IMembershipVerifier;
  waitForDeployment(): Promise<this>;

  interface: IMembershipVerifierInterface;
