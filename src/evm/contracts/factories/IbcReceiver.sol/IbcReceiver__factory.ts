...
import type {
  IbcReceiver,
  IbcReceiverInterface,
} from "../../IbcReceiver.sol/IbcReceiver";
...
export class IbcReceiver__factory {
  static readonly abi = _abi;
  static createInterface(): IbcReceiverInterface {
    return new Interface(_abi) as IbcReceiverInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IbcReceiver {
    return new Contract(address, _abi, runner) as unknown as IbcReceiver;
  }
}
