...
import type {
  ...
  IbcUniversalChannelMWInterface,
} from "../../IbcMiddleware.sol/IbcUniversalChannelMW";
...
export class IbcUniversalChannelMW__factory {
  static readonly abi = _abi;
  static createInterface(): IbcUniversalChannelMWInterface {
    return new Interface(_abi) as IbcUniversalChannelMWInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IbcUniversalChannelMW;
  }
}
