...
export interface IbcReceiverInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IbcReceiver extends BaseContract {
  connect(runner?: ContractRunner | null): IbcReceiver;
  waitForDeployment(): Promise<this>;

  interface: IbcReceiverInterface;
