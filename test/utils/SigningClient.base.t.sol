...
contract SigningBase is Test {
    ...
    function readBytes32FromJson(string memory fileName, string memory property) public returns (bytes32) {
    ...
    function readUint64FromJson(string memory fileName, string memory property) public returns (uint64) {
        string memory blockJson = vm.readFile(string.concat(rootDir, fileName));
