...
contract CrossL2InboxBase is SigningBase {
    ...
    function setUp() public {
        ...
        // validAncestorSignature = abi.encodePacked(r0, s0, v0); // Annoingly, v, r, s are in a different order than
        // those
        ...
        // vm.createSelectFork("https://base-sepolia.g.alchemy.com/v2/lTfokMxkVuwtrXEz07t7GRmWA1oFGftf");
    ...
    function test_clientUpdate_success() public {
        crossProver.updateClient(
            abi.encodePacked(
                hex"47b710871b073798b451908c50fbc425afb591039f8a1a6976e9e5a48f9d518a",
                hex"345d007f9fc2a675fa2e1e2dca3b238512784be1288c2a608c78887f012242b069ee9111552998a25a7ede07fd82ca03d018ba3eeac39a79c6017d6d1fdae8ce1b"
            ),
            948_425,
            uint256(bytes32(0xd46518e43cd626c0d0e4f0e5251e47a21bc86e9382eeb27725cf15ce84b2e838))
        );
