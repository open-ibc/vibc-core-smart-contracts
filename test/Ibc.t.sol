...
contract IbcTest is Test {
    ...
    function test_channel_proof_key() public {
        ...
        assertEq(
            key,
            Ibc.channelProofKey('polyibc.eth1.71C95911E9a5D330f4D621842EC243EE1343292e', Ibc.toBytes32('channel-0'))
        );
    }

    function test_string_to_bytes32() public {
        assertEq(bytes32(hex'6368616e6e656c2d30'), Ibc.toBytes32('channel-0'));
    }
    ...
    function test_uint256_to_string() public {
        ...
        assertEq('112233445566', Ibc.toStr(112233445566));
        assertEq('16', Ibc.toStr(16));
    }

    function test_string_to_uint256() public {
        assertEq(1, Ibc.toUint('1'));
        assertEq(112233445566, Ibc.toUint('112233445566'));
        assertEq(16, Ibc.toUint('16'));
    }
